...
class Material(DeepObj):
    def __init__(self, name=None, device="cpu"):
        if "/" in name:
            print("Warning: Material name {} should not contain '/'".format(name))
            self.name = "vacuum"
        else:
...
SELLMEIER_TABLE = {
    ...
    "n-sf5": [1.524181889, 0.011254756, 0.187085527, 0.0588995392, 1.42729015, 129.1416750], 
    ...
    "pk2": [0.9337732, 0.0054368, 0.30077, 0.016653, 0.93760, 96.1682],
    "s-bal42": [1.3957, 0.0112219, 0.0718505, -0.0252117, 1.2712927, 134.4979],
    "sf1": [1.5591, 0.012148, 0.28424, 0.05345, 0.96884, 112.1748],
    "sf11": [1.7385, 1.3607e-2, 3.1117e-1, 6.1596e-2, 1.1749, 1.2192e2],
    "sf59": [1.8165, 0.0143704, 0.4288936, 0.0592801, 1.0718628, 121.4199],
    "sk5": [0.991463823, 0.005227305, 0.495982121, 0.0172733646, 0.987393925, 98.35945790],
