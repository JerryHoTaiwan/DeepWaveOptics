...
class Surface(DeepObj):
    ...
    def intersect(self, ray, n):
        ...
        o_travel_dist = torch.norm(new_o - ray.o, dim=-1)
        ...
        if ray.coherent:
            ...
            ray.opl = new_opl
            # print("opl update, point: ", ray.o[29606], "valid: ", ray.ra[29606], "ior: ", n, "t: ", t[29606].item(), "opl: ", ray.opl[29606].item())
            # print("travel distance: ", o_travel_dist[29606].item())
...
class Aperture(Surface):
    ...
    def ray_reaction(self, ray, n1=1.0, n2=1.0, refraction=False):
        ...
        if ray.coherent:
            ...
            new_opl[~valid] = ray.opl[~valid]
            ray.opl = new_opl
            # print("opl update, point: ", ray.o[29606], "valid: ", ray.ra[29606], "t: ", t[29606].item(), "opl: ", ray.opl[29606].item())
